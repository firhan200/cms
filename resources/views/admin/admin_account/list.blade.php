            ...
            <div class="box">
            	<div class="row">
            		...
            		<div class="col-sm-8" align="right">
            			<a href="{{ url('/admin/'.$objectName.'/add') }}" class="btn btn-primary" data-toggle="tooltip" title="Add {{ str_replace('_', ' ', $objectName) }}"><i class="fa fa-plus"></i> Add {{ str_replace('_', ' ', $objectName) }}</a>
            			@if($is_deleted==0)
